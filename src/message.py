...
def message_send_v1(token, channel_id, message):
    ...
    data['channels'][channel_id]['messages'].append(new_message)
    return {
        'message_id': message_id,
    }
...
def message_remove_v1(token, message_id):
    ...
    data['channels'][channel_id]['messages'][message_id]['message'] = ''
...
def message_edit_v1(token, message_id, message):
    ...
    if validuser != 1:
        raise AccessError('Message was not sent by user and user is not an owner of the channel')
    data['channels'][channel_id]['messages'][message_id]['message'] = message
    return {
    }
...
def message_senddm_v1(token, dm_id, message):
    ...
    data['dms'][dm_id]['messages'].append(new_message)
    return {
        'message_id': message_id
    }