...
def test_message_edit(clear):
    ...
    message_send_v1(token['token'], channel_id['channel_id'], '3333')
...
def test_message_edit_invalid_token(clear):
    '''
...
def test_message_edit_dm(clear):
    '''
...
def test_message_share_dm(clear):
    ...
    assert messages['messages'][0]['message'] == 'Hello'
def test_message_share_dm_access_error(clear):
    '''
